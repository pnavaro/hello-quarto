...
[[pnavaro.quarto.pub/hello-quarto](https://pierre-navaro.quarto.pub/hello-quarto/)]{.custom-url}
...
- This is the best alternative to quarto.
...
1) Install quarto : `brew install quarto`
...
- Python tools for Big Data (Jupyter notebooks) : [quarto-html](https://pnavaro.github.io/big-data/quarto), [jupyterbook](https://pnavaro.github.io/big-data), [repo](https://github.com/pnavaro/big-data)
