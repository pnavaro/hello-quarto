...
- [Python tools for Big Data](https://pnavaro.github.io/big-data/quarto)
- [Statistique en grande dimension](https://pnavaro.github.io/tutoriel-grande-dimension/)
- [A Python Package for Sampling from Copulae: clayton](https://github.com/computorg/published-202301-boulin-clayton)
- [Partitionnement élagué avec des divergences de Bregman](https://brecheteau.pages.math.cnrs.fr/trimmed-bregman-clustering/quarto)
